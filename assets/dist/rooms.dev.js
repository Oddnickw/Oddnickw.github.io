...
function () {
  ...
  _createClass(Room, [{
    ...
    value: function displayRoom() {
      ...
      console.log(exits); //very clumsy solution for capitalizing first exit
      ...
      exits.length != 1 ? println(this.description + " " + exits.join(", ") + ", and " + lastExit + ".") : println(this.description + " " + exits.join(", ") + ".");
